> [!WARNING]
> This repository is for muwanx project.  
> Following each sync with the original mujoco_playground repository, the text `file="../../../../../mujoco_menagerie` should be replaced with `file="../../../../../../mujoco_menagerie` to adjust the dependency paths.
