...
import { quatApplyInv } from 'mjswan/math';
import type { PolicyState } from 'mjswan/types';
import type { PolicyRunner } from 'mjswan/types';

// NOTE: the four motion-command-coupled observations (tracking, target joint
// pos, target root z, target projected gravity) were migrated to declarative
// DSL builders in dsl_terms.py (issue #79) and removed from this file.
